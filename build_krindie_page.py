# -*- coding: utf-8 -*-
"""
krindie_final.csv → krindie_report.html
...
SRC = os.path.join(BASE, "krindie_final.csv")
ART = os.path.join(BASE, "arthouse_final.csv")
OUT = os.path.join(BASE, "krindie_report.html")
...
HTML = """<title>한국 독립영화 흥행 실적 · 2024–2026</title>
<style>
  :root{
