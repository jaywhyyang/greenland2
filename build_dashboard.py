...
def precise_forecast():
    ...
    # 호프(나홍진 대작) 7/15 개봉 → 3주차 편성 대폭 삭감 예상. 데이터 유추 기준:
    # 개봉 3주차 페이드작이 대형 신작을 맞으면 스크린 절반 이상 상실 + 본작은 서울·수도권 관객
...
def sixtyk_countdown():
    ...
    if pf:
        ...
        return ('  <div class="forecast" style="background:linear-gradient(135deg,#241f16 0%,#1a1d27 70%);border-color:#5a4a2f">'
                ...
                f'<b style="color:#f4c89a">6만은 미달 전망</b>(3주차 호프 개봉으로 편성 대폭 삭감 예상 + 서울·수도권 관객 67% 의존). '
